...
function AboutSection() {
  return (
    <div className="font-ralewayitems-center mx-auto flex max-w-[600px] justify-center pb-6">
      <div className="mb-10 mt-6 inline-flex flex-col items-center justify-start gap-8 text-center sm:py-6">
        ...
        <div className="flex w-full flex-col items-center justify-start gap-2.5 rounded-lg p-5 outline outline-1 outline-orange-500 md:w-[568px]">
          ...
          <div className="flex flex-col items-center justify-start gap-3.5 self-stretch">
            <h3 className="text-center font-raleway text-xl font-bold capitalize text-white">
              Unique QR Cards
            </h3>
            <p className="justify-start self-stretch text-center font-raleway text-base font-normal leading-6 text-white">
        ...
        <div className="flex w-full flex-col items-center justify-start gap-2.5 rounded-lg p-5 outline outline-1 outline-orange-500 md:w-[568px]">
          <div className="relative h-10 w-10 overflow-hidden rounded bg-orange-500 p-1">
            <MdOutlinePrivacyTip className="left-[5px] top-[5px] h-full w-full font-raleway text-white" />
          </div>
          <div className="flex flex-col items-center justify-start gap-3.5 self-stretch">
            <h3 className="text-center font-raleway text-xl font-bold capitalize text-white">
              Privacy First
