...
export const WaitListTable = () => {
  const data = [
    { date: "Jul 5, 2025", name: "Bessie Cooper", email: "bill.sanders@example.com" },
    { date: "Jul 6, 2025", name: "John Doe", email: "john.doe@example.com" },
    { date: "Jul 7, 2025", name: "Jane Smith", email: "jane.smith@example.com" },
    { date: "Jul 8, 2025", name: "Michael Brown", email: "michael.brown@example.com" },
  ];
